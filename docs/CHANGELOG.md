...
- Fix: National flags no longer show as invisible (Chrome on Linux) or as emoji characters — they are now rendered from bundled Twemoji SVGs (twitter/twemoji v14.0.2, CC BY 4.0), which display consistently across all browsers and platforms.
